...
<body onload="mueveReloj()" background="../Imagenes/Imagenes-Empleado/fondo.avif">
    ...
    <div class="btnAdd">
        <a href="../php/AgregarProducto.php"><button id="AddProd">Agregar producto <svg xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" viewBox="0 0 24 24" fill="none">
        ...
        <div id="cont">
            ...
            <table class="" border="0">
                ...
                <td><a href="../php/EditarProducto.php?ID=<?=$producto["IDproducto"]?>"><button><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" height="20px" width="20px" version="1.1" id="Capa_1" viewBox="0 0 348.882 348.882" xml:space="preserve">
                    ...
                    <a href="../php/ocultarProducto.php?ID=<?=$producto["IDproducto"]?>"><button><svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 24 24" fill="none">
